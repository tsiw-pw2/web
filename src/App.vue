...
<template>
    <div class="flex h-screen w-full flex-col overflow-hidden bg-neutral-950 pb-2">
        <AppHeader />
        <main class="mx-2 flex flex-1 flex-col overflow-y-auto overscroll-none rounded-lg bg-neutral-50 py-8">
            <div class="mx-auto flex w-full max-w-[1056px] flex-1 flex-col gap-6 px-4">
				<RouterView />
			</div>
        </main>
    </div>
